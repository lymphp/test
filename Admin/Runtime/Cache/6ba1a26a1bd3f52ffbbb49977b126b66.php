    ...
    <tr>
        <td bgcolor="#666666"><table width="700" border="0" align="center" cellpadding="0" cellspacing="1">
                <tr bgcolor="#deb887" height="35">
                    ...
                    <tr bgcolor="#FFFFFF">
                        <td height="20"><div align="center"><img src="<?php echo ($selectgood["goods_images1"]); ?>" width="80" height="80"> </div></td>
                        <td height="20"><div align="center"><?php echo ($selectgood["goods_name"]); ?></div></td>
                        <td height="20"><div align="center"><?php echo ($selectgood["goods_marketPrice"]); ?></div></td>
                        <td height="20"><div align="center"><?php echo ($selectgood["goods_vipPrice"]); ?></div></td>
                        <td height="20"><div align="center"><?php echo ($selectorder["slc"]); ?></div></td>
                        <td height="20"><div align="center"><?php echo ($selectorder['slc']*$selectgood['goods_vipPrice']); ?></div></td>
                    </tr>
                <tr bgcolor="#FFFFFF">
                    <td height="30" colspan="6">
                        <div align="right">总计费用:&nbsp;元&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </div></td>
                </tr>
            </table></td>
    </tr>
...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td colspan="3"><div align="left"><?php echo ($selectorder["xiadanren"]); ?></div></td>
    </tr>
    <tr>
        <td height="20"><div align="left" class="style2">收货人：</div></td>
        <td height="20" colspan="3"><div align="left"><?php echo ($selectorder["shouhuoren"]); ?></div></td>
    </tr>
    <tr>
        <td height="20"><div align="left" class="style2">收货人地址：</div></td>
        <td height="20" colspan="3"><div align="left"><?php echo ($selectorder["dizhi"]); ?></div></td>
    </tr>
    <tr>
        <td height="20"><div align="left" class="style2">邮&nbsp;&nbsp;编：</div></td>
        <td width="145" height="20"><div align="left"><?php echo ($selectorder["youbian"]); ?></div></td>
        <td width="66"><div align="left" class="style2">电&nbsp;&nbsp;话：</div></td>
        <td width="158"><div align="left"><?php echo ($selectorder["tel"]); ?></div></td>
    </tr>
    <tr>
        <td height="20"><div align="left" class="style2">E-mail:</div></td>
        <td height="20"><div align="left"><?php echo ($selectorder["email"]); ?></div></td>
        <td height="20">&nbsp;</td>
        <td height="20">&nbsp;</td>
    </tr>
    <tr>
        <td height="20"><div align="left" class="style2">送货方式：</div></td>
        <td height="20"><div align="left"><?php echo ($selectorder["shff"]); ?></div></td>
        <td height="20"><div align="left" class="style2">支付方式：</div></td>
        <td height="20"><div align="left"><?php echo ($selectorder["zfff"]); ?></div></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td height="20"><div align="left"><?php echo ($selectorder["time"]); ?></div></td>
    </tr>
</table>
</body>
</html>